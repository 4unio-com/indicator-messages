 ...
 */
class MessagesServiceTest: public IndicatorServiceTest
{
  public:
    virtual ~MessagesServiceTest() {}
    MessagesServiceTest(): IndicatorServiceTest(INDICATOR_MESSAGES_DBUS_NAME,
 ...
 */
TEST_F(MessagesServiceTest, HelloWorld)
{
  ASSERT_TRUE(true);
}
